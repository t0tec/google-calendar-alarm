package org.olmec.ui.mvvm.viewmodel;
...
import org.olmec.ui.mvvm.Preferences;
...
public class ViewModel {
  ...
  @Inject
  public ViewModel(GoogleCalendar googleCalendar) {
  ...
  public void showEvents() {
    final List<Event> results = googleCalendar.getEvents(Preferences.getInstance().getValue("googleCalendarId"));
